libname W 'C:\Users\Admin\Desktop\loan\RRinclude0\dataset';
...
outfile='C:\Users\Admin\Desktop\loan\RRinclude0\dataset\Loan_default_train.csv'
dbms=csv
replace;
run;
PROC EXPORT data=w.Loan_default_hold
outfile='C:\Users\Admin\Desktop\loan\RRinclude0\dataset\Loan_default_hold.csv'
dbms=csv
replace;
run;
