...
library(bayesQR)
#**************************input data***********************************#
default_train<-read.csv('C:/Users/Admin/Desktop/loan/RRinclude0/dataset/Loan_default_train.csv')
#default_hold<-read.csv('C:/Users/Admin/Desktop/loan/RRinclude0/dataset/Loan_default_hold.csv')
#***********************************************************************#
...
#wl
para<-data.frame(wl)
write.csv(para,'C:/Users/Admin/Desktop/loan/RRinclude0/dataset/para6_7.csv')
#********************************************************************#
par(mfrow=c(1,1))
